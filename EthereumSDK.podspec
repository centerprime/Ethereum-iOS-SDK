...
Pod::Spec.new do |s|
  s.name             = 'EthereumSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of EthereumSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/centerprime/EthereumSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'centerprime' => 'support@centerprime.technology' }
  s.source           = { :git => 'https://github.com/centerprime/EthereumSDK.git', :tag => s.version.to_s }
